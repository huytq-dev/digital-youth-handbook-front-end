...
export const anToanMangTopic: LearningTopic = {
  id: "an-toan-mang",
  title: "Sử dụng mạng xã hội an toàn, hiệu quả và thông minh",
  objectives: [
  ...
  content: {
    ...
    sections: [
      {
        title: "Giới thiệu",
        content: `Trong thời đại số, mỗi học sinh hôm nay đều đang sống trong "hai thế giới": thế giới thật và thế giới mạng. Chỉ với một chiếc điện thoại thông minh, các em có thể học tập, giải trí, kết nối bạn bè khắp nơi. Mạng xã hội vì thế không còn là điều xa lạ mà đã trở thành một phần của đời sống học sinh. Tuy nhiên, đi cùng với cơ hội là những thách thức và hiểm họa khó lường: lừa đảo, tin giả, bạo lực mạng, nghiện Internet, tổn thương tâm lý…

Vấn đề không phải là có dùng mạng xã hội hay không, mà là dùng như thế nào. Nếu thiếu hiểu biết và kỹ năng, các em rất dễ trở thành nạn nhân của thế giới ảo. Ngược lại, nếu biết sử dụng đúng cách, mạng xã hội sẽ trở thành công cụ học tập hiệu quả, là môi trường lan tỏa điều tốt đẹp và nuôi dưỡng ước mơ.

Vì vậy, mỗi học sinh cần hình thành cho mình bản lĩnh số và phương châm hành động rõ ràng:
Dùng mạng xã hội có mục đích – Chia sẻ có suy nghĩ – Giao tiếp có văn hóa – Tự bảo vệ bản thân.
...
Các em cũng có thể kết bạn với học sinh trong trường, trong khu mình sống thậm chí là kết bạn với những người bạn nước ngoài. Khoảng cách địa lý hay thời gian không còn là trở ngại cho những tình bạn đẹp xuyên quốc gia.`,
      },
      {
        title: "Những mối nguy hại tiềm ẩn khi sử dụng mạng xã hội",
        subSections: [
          {
      ...
      {
        title: "Kỹ năng sử dụng mạng xã hội an toàn",
        subSections: [
          {
...
- Mật khẩu
- Ảnh riêng tư
- Không nên đăng công khai những thông tin này.

Hãy:
- Đặt mật khẩu mạnh.
- Bật xác thực hai lớp.
- Chỉ kết bạn với người quen biết ngoài đời.
- Mỗi thông tin cá nhân bị lộ giống như một "mảnh ghép" giúp kẻ xấu hiểu rõ về em hơn.`,
          },
          {
...
Vì vậy hãy sử dụng mạng xã hội một cách văn minh, không hùa theo cộng đồng mạng để chửi rủa, miệt thị người khác. Nếu có điều gì buồn bực hay bất đồng quan điểm với bạn bè, người thân, các em hãy chọn cách nói chuyện trực tiếp để cùng nhau đưa ra cách giải quyết phù hợp. Mạng xã hội là ảo nhưng nỗi đau là thật, đừng để một dòng chữ trong lúc không suy nghĩ làm ảnh hưởng đến cuộc đời của một con người.`,
          },
          {
...
Mạng xã hội có thể làm cho cuộc sống tốt đẹp hơn nhưng cũng có thể hủy hoại con người nếu như sử dụng không đúng cách. Mạng xã hội chỉ nên là công cụ, không phải trung tâm cuộc sống.

Hãy:
- Chỉ dùng sau khi hoàn thành việc học.
- Giới hạn thời gian mỗi ngày.
- Không dùng điện thoại quá khuya.

Thay vì chỉ nhìn màn hình, các em hãy:
- Chơi thể thao.
- Đọc sách.
- Trò chuyện trực tiếp với gia đình, bạn bè.

Cuộc sống thật luôn phong phú và ý nghĩa hơn thế giới ảo.

Mạng xã hội không xấu, điều quan trọng là cách con người sử dụng nó. Một chiếc điện thoại có thể trở thành "cánh cửa tri thức", nhưng cũng có thể là "chiếc bẫy vô hình" nếu thiếu hiểu biết và kiểm soát. Với học sinh – lứa tuổi đang hình thành nhân cách và thế giới quan – việc sử dụng mạng xã hội đúng cách càng có ý nghĩa quyết định.

Mỗi học sinh hãy ghi nhớ phương châm hành động của mình trong không gian mạng:
- Không vội tin – Không tùy tiện chia sẻ.
- Không xúc phạm – Không hùa theo điều xấu.
- Không để mạng điều khiển – Biết làm chủ thời gian.
- Luôn tự bảo vệ bản thân và tôn trọng người khác.

Khi mỗi em biết sống có trách nhiệm trên mạng như ngoài đời, không gian số sẽ trở thành môi trường học tập an toàn, nhân văn. Từ đó, mạng xã hội không còn là nỗi lo, mà sẽ trở thành công cụ giúp các em trưởng thành, lan tỏa những điều tốt đẹp và xây dựng một cộng đồng mạng văn minh, lành mạnh.`,
          },
        ],
      },
    ],
  ...
  quiz: [
    {
      id: 1,
      question: "Điều nào sau đây là lợi ích chính của mạng xã hội đối với học sinh?",
      options: [
        "Giúp học sinh kết nối với những người có cùng sở thích",
        "Làm mất thời gian học tập",
        "Gây nghiện và ảnh hưởng sức khỏe",
        "Dễ bị lừa đảo",
      ],
    ...
    {
      id: 2,
      question: "Để bảo mật thông tin cá nhân trên mạng xã hội, học sinh nên:",
      options: [
        "Đăng tất cả thông tin cá nhân công khai",
    ...
    {
      id: 3,
      question: "Trước khi chia sẻ thông tin trên mạng xã hội, học sinh nên tự hỏi:",
      options: [
        "Thông tin này có đúng không?",
        "Bạn bè có thích không?",
        "Có được nhiều like không?",
    ...
    {
      id: 4,
      question: "Ứng xử văn minh trên mạng xã hội có nghĩa là:",
      options: [
        "Chửi rủa người khác khi không đồng ý",
        "Không xúc phạm hay miệt thị người khác",
        "Trút giận lên mạng khi buồn",
    ...
    {
      id: 5,
      question: "Để tránh bị lừa đảo trên mạng xã hội, học sinh nên:",
      options: [
        "Chia sẻ thông tin cá nhân khi được yêu cầu",
        "Nhấn vào mọi link lạ",
        "Không chia sẻ thông tin cá nhân và từ chối gửi ảnh nhạy cảm",
        "Gửi tiền cho người lạ khi họ hứa thưởng",
      ],
      correctAnswerIndex: 2,
    },
  ],
