...
import tinhNguyenImageMobile from "@/assets/infographic_chu_de/chu_de_5/Chuong_5_mobile.png";
import tinhNguyenImageDesktop from "@/assets/infographic_chu_de/chu_de_5/Chuong_5_desktop.png";
import tinhNguyenGioiThieu from "@/assets/infographic_chu_de/chu_de_5/thanh_nien_tinh_nguyen_gioi_thieu.png";
import tinhNguyen13 from "@/assets/infographic_chu_de/chu_de_5/thanh_nien_tinh_nguyen_1.3.png";
import tinhNguyen22 from "@/assets/infographic_chu_de/chu_de_5/thanh_nien_tinh_nguyen_2.2.png";
import tinhNguyen24 from "@/assets/infographic_chu_de/chu_de_5/thanh_nien_tinh_nguyen_2.4.png";
...
Bạo lực học đường và xâm hại thân thể không phải là vấn đề cá nhân mà là trách nhiệm của toàn xã hội. Giáo dục kỹ năng phòng ngừa cho thanh thiếu niên chính là đầu tư cho tương lai, giúp các em lớn lên an toàn, tự tin và nhân văn. Khi mỗi học sinh biết nói không với bạo lực, biết tự bảo vệ mình và lan tỏa yêu thương, trường học sẽ thực sự trở thành nơi an toàn để học tập, rèn luyện và trưởng thành.`,
  ...
  infographicUrls: [
    tinhNguyenImageMobile,
    tinhNguyenImageDesktop,
  ],
  quiz: [
    {
      id: 1,
