...
import { LearningTopicsHeader } from "@/features/learning-topics/components/learning-topics-header";
    ...
    <>
      ...
      {!isDetail && (
        <main 
          ...
          style={{ backgroundImage: `url("${doodleDotPattern}")` }} // Thêm pattern nền
        >
          ...
          <div className="mx-auto max-w-5xl px-4 relative z-10">
            ...
            <header className="mb-16 text-center relative">
              {/* Sticker Badge */}
              <div className="inline-block bg-yellow-300 border-2 border-black px-5 py-2 rounded-tl-xl rounded-br-xl shadow-[4px_4px_0px_black] mb-6 -rotate-3 hover:rotate-0 transition-transform cursor-default">
              ...
              <div className="relative inline-block">
                <h1 className="mt-3 text-4xl md:text-6xl font-black leading-none text-slate-900 uppercase tracking-tight relative z-10">
              ...
              <p className="mt-8 mx-auto max-w-2xl text-lg font-bold text-slate-700 leading-relaxed bg-white/60 backdrop-blur-sm p-4 rounded-2xl border-2 border-dashed border-slate-300">
      ...
      {isDetail && (
        ...
        >
          {!topic ? (
            ...
            <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center relative z-10">
