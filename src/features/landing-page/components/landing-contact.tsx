...
export const LandingContact = () => {
    ...
    return (
        <section ref={sectionRef} className="relative py-20 overflow-hidden bg-[#fff9f0] border-b-4 border-black font-sans">
                        ...
                        <div className="md:w-3/5 p-8 md:p-10 bg-white">
                            <form className="space-y-1" onSubmit={handleSubmit}>
                                ...
                                <BrutalistInput
                                    label="Chủ đề"
                                    name="subject"
                                    placeholder="VD: Hỏi về học bổng"
                                ...
                                <BrutalistInput
                                    ...
                                    name="body"
                                    rows={4}
                                    placeholder="Mình đang gặp khó khăn ở phần..."
